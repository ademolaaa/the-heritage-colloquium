    ...
    <Section background="darker" className="pt-40 pb-20 min-h-screen flex items-center">
      <div className="container mx-auto px-6">
        <div className="max-w-md mx-auto bg-black/40 backdrop-blur-md p-8 rounded-2xl border border-white/10">
          <h1 className="font-display text-4xl text-white mb-2 text-center">Join Us</h1>
          <p className="text-gray-400 text-center mb-8">Become a part of the Ahiajoku community.</p>

          {success ? (
            <div className="text-center">
              <div className="bg-green-500/10 border border-green-500/20 text-green-500 px-4 py-3 rounded-xl mb-4">
          ...
          <p className="mt-6 text-center text-gray-400 text-sm">
            Already have an account? <Link to="/login" className="text-gold-500 hover:text-white transition-colors">Sign In</Link>
          </p>
        </div>
      </div>
    </Section>

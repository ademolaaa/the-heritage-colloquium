...
ALTER TABLE gallery ADD COLUMN IF NOT EXISTS event_id VARCHAR(255);
ALTER TABLE gallery ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE contributors ADD COLUMN IF NOT EXISTS photo_media_id VARCHAR(255);
ALTER TABLE contributors ADD COLUMN IF NOT EXISTS socials JSONB DEFAULT '[]';

ALTER TABLE social_links ADD COLUMN IF NOT EXISTS handle VARCHAR(255);
